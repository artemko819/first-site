  ...
  return (
    <>
      ...
      <div className="lg:flex justify-center flex-col rounded-lg md:grid-cols-1 mt-3 md:grid md:grid-cols-5 gap-y-10 md:gap-10">
        <h1 className=" text-center leading-10 lg:text-6xl sm:text-3xl  leading-4">
          Удобный сервис для обмена валюты
        </h1>
        <h2 className="text-center lg:text-[32px] sm:text-[18px]  sm:leading-5">Онлайн обменник криптовалют и электронных денег HestiaexChange</h2>
